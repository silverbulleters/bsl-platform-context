...
public class TypeValue {
  ...
  public static TypeValue createFromData(DataFromCollector.TypeValue data) {
    var resource = new Resource(data.getNameRu(), data.getName());
    return new TypeValue(resource);
  }
}
